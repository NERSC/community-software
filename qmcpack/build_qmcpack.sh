# This is the buildscript from the QMCPACK developers with the only difference
# being that specific versions on the modules have been removed for greater 
# compatibility. Passed basic testing.
...
echo source_folder:$source_folder install_folder:$install_folder
